...
////void main( )
////{
////	const vec3 uLightPos = vec3( 0.0 , 0.5, 0.0 );
////	vec3 transNorm = normalize(norm );
////	vec3 ECposition = ( model * vec4(pos, 1.0) ).xyz;
////	vLightIntensity = dot(normalize(uLightPos- ECposition),transNorm);
////	vLightIntensity = abs(vLightIntensity);
////	vCol = vec4(vLightIntensity*0.0,vLightIntensity*0.2,vLightIntensity*0.0,1.0);
////	gl_Position = projection * view * model * vec4(pos, 1.0);
////}
////